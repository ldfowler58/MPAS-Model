...
!
!==================================================================================================================
 module CA2G_br_instance
 use mpas_kind_types,only: RKIND,StrKIND

 public
 save

!this module is the resource file for brown carbon parameters. it is the same as CA2G_instance_CA.br.rc in the
...
!sigma of lognormal number distribution:
 ...
 character(len=*),parameter:: point_emissions_srcfilen = '/dev/null'

!==================================================================================================================
 end module CA2G_br_instance
!==================================================================================================================
