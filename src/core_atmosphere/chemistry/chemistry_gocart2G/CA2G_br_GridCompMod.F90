!=================================================================================================================
 ...
 use CA2G_br_instance_CA,only: nbins,particle_radius_microns,particle_density,fscav,molecular_weight, &
...
!--- types needed to define CA2G_br:
 ...
 type,extends(GA_Environment),public:: CA2G_br_GridComp
    ...
    contains
       ...
       procedure:: run2_GridComp => run2_CA2G_br_GridComp
...
!=================================================================================================================
 subroutine run2_CA2G_br_GridComp(self_params,self,its,ite,jts,jte,kts,kte)
!=================================================================================================================
!--- input arguments:
...
!-----------------------------------------------------------------------------------------------------------------
 call mpas_log_write(' ')
 call mpas_log_write('--- enter subroutine run2_CA2G_br_GridComp:')
...
!   __RC__)
 ...
 call mpas_log_write('--- end subroutine run2_CA2G_br_GridComp:')

 end subroutine run2_CA2G_br_GridComp
